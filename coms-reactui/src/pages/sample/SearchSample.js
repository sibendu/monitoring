...
const SearchProcess = (props) => {
  ...
  const columns = [
    ...
    { field: 'name',headerName: 'Name',width: 150, editable: false,headerClassName: 'super-app-theme--header',headerAlign: 'center'},
    { field: 'email', headerName: 'Email', width: 150, editable: false, headerClassName: 'super-app-theme--header', headerAlign: 'center'},
    { field: 'username', headerName: 'User Name', type: 'number', flex: 1, editable: false, headerClassName: 'super-app-theme--header', headerAlign: 'center'},
    { field: 'address', headerName: 'Address', flex: 3, description: 'This column has a value getter and is not sortable.', sortable: false,
      valueGetter: (params) =>
        `${params.row.address.street || ''} ${params.row.address.city || ''} ${params.row.address.zipcode || ''}`,
  ...
  function search(){
    const searchResponse = {
      ...
      "records":[
        { id: 11, lastName: 'Snow xx', firstName: 'Jon', age: 35 },
        { id: 15, lastName: 'Targaryen', firstName: 'Daenerys', age: null }
      ]
    };
